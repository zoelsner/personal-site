...
const projects: Project[] = [
  ...
  },
  {
    ...
    meta: "In Progress",
    name: "Qook",
    shortDesc: "Meals matched to your energy level.",
    previewDesc: "3 watercolor cards · Instacart checkout",
    color: "#B85A3B",
    diameter: 220,
    href: "/work/qook",
  },
  {
    ...
    previewDesc: "Built with Next.js, Instrument Serif, and spare Sundays.",
    color: "#5C7A4A",
    diameter: 100,
    href: "/about",
  },
